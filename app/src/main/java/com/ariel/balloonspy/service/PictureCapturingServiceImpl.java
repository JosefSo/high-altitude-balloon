...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    private void takePicture() throws CameraAccessException {
        ...
        //captureBuilder.set(CaptureRequest.CONTROL_MODE, CaptureRequest.CONTROL_SCENE_MODE_SUNSET);
    ...
    private Range<Integer> getRange() {
        ...
        try {
            chars = manager.getCameraCharacteristics(currentCameraId);
